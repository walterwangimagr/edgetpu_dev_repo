...
parser.add_argument('--train_annotations_dir', type=str, default='../data/voc2012/VOCdevkit/VOC2012/voc_train.txt', help='train annotations path')
parser.add_argument('--test_annotations_dir', type=str, default='../data/voc2012/VOCdevkit/VOC2012/voc_train.txt', help='test annotations path')
parser.add_argument('--class_name_dir', type=str, default='../data/voc2012/VOCdevkit/VOC2012/voc.names', help='classes name path')

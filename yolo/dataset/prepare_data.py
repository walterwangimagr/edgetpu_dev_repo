...
if __name__ == '__main__':
    base_dir = "/home/walter/git/tfyolo/data/voc2012/VOCdevkit/VOC2012"
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, default='/home/walter/git/tfyolo/data/voc2012/VOCdevkit/VOC2012', help='data directory')
    parser.add_argument('--class_name_dir', type=str, default=base_dir + '/voc.names', help='class name dir')
    parser.add_argument('--output_dir', type=str, default='/home/walter/git/tfyolo/data/voc2012/VOCdevkit/VOC2012', help='output text directory')
    opt = parser.parse_args()

    data_prepare = VOCPrepare(opt.data_dir,
                              opt.class_name_dir,
    ...
    # data_prepare = VOCPrepare(os.path.join(opt.data_dir, 'test/VOCdevkit/VOC2012'),
    #                           opt.class_name_dir,

...
from dataset.read_data import DataReader, transforms, YOLODataReader
...
if __name__ == '__main__':
    ...
    imgs_dir = "/app/data/images/train"
    labels_dir = "/app/data/labels/train"
    DataReader = YOLODataReader(imgs_dir, labels_dir)
